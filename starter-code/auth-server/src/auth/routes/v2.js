...
router.get('/:model', bearerAuth, acl('read'), handleGetAll); // acl('read'), bearerAuth, handleGetAll);??
router.get('/:model/:id', bearerAuth, acl('read'), handleGetOne); // acl('read'), bearerAuth, handleGetOne);??
